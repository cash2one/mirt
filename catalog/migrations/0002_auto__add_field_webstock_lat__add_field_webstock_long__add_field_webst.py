...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebStock.lat'
        db.add_column(u'catalog_webstock', 'lat',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebStock.long'
        db.add_column(u'catalog_webstock', 'long',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebStock.mode'
        db.add_column(u'catalog_webstock', 'mode',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebStock.phone'
        db.add_column(u'catalog_webstock', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebStock.lat'
        db.delete_column(u'catalog_webstock', 'lat')

        # Deleting field 'WebStock.long'
        db.delete_column(u'catalog_webstock', 'long')

        # Deleting field 'WebStock.mode'
        db.delete_column(u'catalog_webstock', 'mode')

        # Deleting field 'WebStock.phone'
        db.delete_column(u'catalog_webstock', 'phone')
